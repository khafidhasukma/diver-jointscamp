        ...
        <div className="bg-bgAdmin text-sm">
            <div className="flex gap-8">
                ...
                <div className="w-4/5 px-4 py-6">
                    ...
                    <Link to="/admin/posts/create" className="rounded bg-darkBlue px-10 py-3 font-bold text-white">
                        Add Stories
                    </Link>
                    <table className="mt-8 w-full rounded-lg bg-white">
                        ...
                        {posts.map((post, index) => (
                            <tr>
                                ...
                                <td width="20%">{post.created_at}</td>
                                <td width="30%" className="flex gap-2">
                                    <div>
                                        <Link className="rounded bg-success px-4 py-2 font-medium text-white">
                                            View
                                        </Link>
                                    </div>
                                    <div>
                                        <Link className="rounded bg-primary px-4 py-2 font-medium text-white">
                                            Edit
                                        </Link>
                                    </div>
                                    <div>
                                        <Link className="rounded bg-delete px-4 py-2 font-medium text-white">
                                            Delete
                                        </Link>
                                    </div>
                                </td>
